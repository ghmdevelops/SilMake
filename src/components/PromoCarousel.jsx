...
import { Flame, Sparkles, ChevronLeft, ChevronRight } from "./icons";
...
// `promo` escolhe o ícone: chama quando é promoção de verdade, brilho quando
// é só destaque. O título agora é texto puro — antes trazia o emoji dentro,
// o que fazia o leitor de tela anunciar "fogo Promoção da semana".
export default function PromoCarousel({ products, title = "Promoção da semana", promo = true }) {
      ...
      <div className="promo-carousel-viewport">
        <div className="promo-carousel-heading">
          <span className="promo-badge">
            {promo ? <Flame size={15} /> : <Sparkles size={15} />} {title}
          </span>
        </div>

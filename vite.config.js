  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // Sem isto, o service worker responde QUALQUER endereço digitado na
        // barra com o index.html guardado em cache — inclusive os que
        // pertencem ao servidor. Isso quebraria a volta do Melhor Envio
        // (/api/melhorenvio/callback), que é uma navegação de verdade: o
        // navegador mostraria a loja em vez de entregar o código de
        // autorização para a função. Estas rotas precisam sair para a rede.
